...
class KanjiChecker:
    ...
    def __init__(self):
        ...
        self.gsk_data_path = "src/resource/gsk_data.json"
    ...
    def _load_data(self):
        if not os.path.exists(self.gsk_data_path):
    ...
    def _save_to_json(self):
        with open(self.gsk_data_path, 'w', encoding='utf-8') as f:
            json.dump({
    ...
    def _load_from_json(self):
        with open(self.gsk_data_path, 'r', encoding='utf-8') as f:
            data = json.load(f)
...
def check_to_general_standard_kanji_list(
        text: str,
